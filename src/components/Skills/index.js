...
class Skills extends Component {
    ...
    constructor(props) {
        ...
        this.skills2 = ['Flexbox', 'POO','Functional Analysis','Git','Scrum','Mongo DB','Sql','Responsive Design']
    }
    

    render() {
        var skills1 = this.skills1.map((skill,key) =>
            <h5 key={key} className="title is-5 has-text-white im-robo is-uppercase has-text-centered">{skill}</h5>
        );
        ...
        return (
            <div className="section im-back2 im-sombra-box">
                <div className="container">
                    <h1 className="title is-2 has-text-white has-text-centered"><span style={{ color: "#ff6b52" }}>&#123;</span> Skills <span style={{ color: "#ff6b52" }}>&#125;</span></h1>
